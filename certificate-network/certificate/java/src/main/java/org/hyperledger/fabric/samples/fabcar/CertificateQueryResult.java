 ...
 */
@DataType()
public final class CertificateQueryResult {
    @Property()
    private final String key;

    @Property()
    private final Certificate record;

    public CertificateQueryResult(@JsonProperty("Key") final String key, @JsonProperty("Record") final Certificate record) {
        this.key = key;
        this.record = record;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        CertificateQueryResult other = (CertificateQueryResult) obj;
