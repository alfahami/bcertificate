...
public class Add {
  ...
  public static void main(String[] args) {
    ...
    String contractName="certificatecontract";
    ...
    try {
      ...
      try(Gateway gateway = builder.connect()) {
        ...
        byte[] response = contract.submitTransaction("add", "ALFAHAMI", "00001", "21-05-1992", "Comoros", "Comorian", "Good", "2021", "");

        // Process response
        System.out.println("Process issue transaction response.");
        Certificate certificate = Certificate.deserialize(response);
